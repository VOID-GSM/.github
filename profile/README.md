...
2026년에 시작된 웹 개발 전공 동아리입니다. 웹 서비스를 기획하고 개발하며, 사용자의 경험을 개선하는 서비스를 만들어갑니다.
현재 GIF(GSM Idea Festival) 프로젝트를 운영하고 있습니다.

## Project
### GIF (GSM Idea Festival)
광주소프트웨어마이스터고등학교 아이디어 페스티벌을 하나의 플랫폼에서 운영할 수 있도록 만든 통합 관리 서비스입니다.
